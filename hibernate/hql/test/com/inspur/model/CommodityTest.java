...
public class CommodityTest {
	...
	public void testOrderby(){
		...
		for(Commodity c : commodities){
			...
			System.out.println("sellerId"+c.getSeller().getName());
...
//		String hql = " from Commodity c where c.name like '’≈_'";
//		String hql  = " from Commodity c where c.age not in(20,40)";
		String hql  = " from Commodity c where c.price between 1000 and 5000 and c.category like '%µÁƒ‘%' or name like '%µÁƒ‘%' ";
		Query query = session.createQuery(hql);
		List<Commodity> commodities = query.list();
